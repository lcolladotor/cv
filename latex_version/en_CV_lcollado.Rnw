...
\cvitem{2019}{\httplink[GenomicState]{bioconductor.org/packages/GenomicState}: data for derfinder analyses -- \Sexpr{getDownloads('GenomicState', data = TRUE)} downloads.}
...
\cvitem{2014}{\httplink[derfinderData]{bioconductor.org/packages/derfinderData}: data for derfinder examples -- \Sexpr{getDownloads('derfinderData', data = TRUE)} downloads.}
\input{software.tex}
\input{computer.tex}
\input{teaching.tex}
\input{mentoring.tex}
