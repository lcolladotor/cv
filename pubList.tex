...
\subsection{Pre-prints}
    \begin{enumerate}
        \item Kira A Perzel Mandell$^{*}$, Amanda J Price, Richard Wilton, \textbf{Leonardo Collado-Torres}, Ran Tao, Nicholas J Eagles, Alexander S Szalay, Thomas M Hyde, Daniel R Weinberger, Joel E Kleinman, Andrew E Jaffe$\dagger$. Characterizing the dynamic and functional DNA methylation landscape in the developing human cortex. \emph{bioRxiv} 823781 (2019). doi: \httplink[10.1101/823781]{doi.org/10.1101/823781}.
...
\subsection{Peer-reviewed}
    \begin{enumerate}
        \item Amanda J. Price$^{*}$, \textbf{Leonardo Collado-Torres}$^{*}$, Nikolay A. Ivanov, Wei Xia, Emily E. Burke, Joo Heon Shin, Ran Tao, Liang Ma, Yankai Jia, Thomas M. Hyde, Joel E. Kleinman, Daniel R. Weinberger, Andrew E Jaffe$\dagger$. Divergent neuronal DNA methylation patterns across human cortical development reveal critical periods and a unique role of CpH methylation. \emph{Genome Biology} 2019. doi: \httplink[10.1186/s13059-019-1805-1]{doi.org/10.1186/s13059-019-1805-1}.
        \\ Pre-print: \emph{bioRxiv} 428391 (2018). doi: \httplink[10.1101/428391]{doi.org/10.1101/428391}.
