...
\cvitem{2016}{\httplink[recount]{bioconductor.org/packages/recount}: Explore and download data from the recount project -- 11341 downloads.}
\cvitem{2014}{\httplink[derfinder]{bioconductor.org/packages/derfinder}: Annotation-agnostic differential expression analysis of RNA-seq data at base-pair resolution via the DER Finder approach -- 19523 downloads.}
\cvitem{2014}{\httplink[derfinderPlot]{bioconductor.org/packages/derfinderPlot}: plotting functions for derfinder results -- 9834 downloads.}
\cvitem{2014}{\httplink[regionReport]{bioconductor.org/packages/regionReport}: Generate HTML or PDF reports for a set of genomic regions or DESeq2/edgeR results -- 10925 downloads.}
\cvitem{2014}{\httplink[derfinderHelper]{bioconductor.org/packages/derfinderHelper}: helper functions for derfinder package -- 15933 downloads.}
\cvitem{2014}{\httplink[derfinderData]{bioconductor.org/packages/derfinderData}: data for derfinder examples -- 2229 downloads.}
\input{software.tex}
\input{computer.tex}
\input{teaching.tex}
\input{mentoring.tex}
