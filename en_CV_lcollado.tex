...
\cvitem{2016}{\httplink[recount]{bioconductor.org/packages/recount}: Explore and download data from the recount project -- 787 downloads.}
\cvitem{2014}{\httplink[derfinder]{bioconductor.org/packages/derfinder}: Annotation-agnostic differential expression analysis of RNA-seq data at base-pair resolution via the DER Finder approach -- 7306 downloads.}
\cvitem{2014}{\httplink[derfinderPlot]{bioconductor.org/packages/derfinderPlot}: plotting functions for derfinder results -- 5371 downloads.}
\cvitem{2014}{\httplink[regionReport]{bioconductor.org/packages/regionReport}: Generate HTML or PDF reports for a set of genomic regions or DESeq2/edgeR results -- 5253 downloads.}
\cvitem{2014}{\httplink[derfinderHelper]{bioconductor.org/packages/derfinderHelper}: helper functions for derfinder package -- 6558 downloads.}
\cvitem{2014}{\httplink[derfinderData]{bioconductor.org/packages/derfinderData}: data for derfinder examples -- 1299 downloads.}
\input{software.tex}
\input{computer.tex}
\input{teaching.tex}
\input{mentoring.tex}
